...
** Version 1.5.4 - 2026-09-17 - Sacha Chua

- Bump version again to see if that fixes the tags.

** Version 1.5.3 - 2026-09-17 - Sacha Chua

- New command: subed-delete-duplicate-lines
- Renamed subed-remove-duplicate-speakers to subed-delete-duplicate-speakers.
- Renamed subed-remove-duplicate-speaker-tag-after-merging to subed-delete-duplicate-speaker-tag-after-merging.

** Version 1.5.2 - 2026-09-10 - Sacha Chua

- New commands:
  - subed-insert-subtitle-for-gap to fill the space between two subtitles
  - subed-section-comments-for-ffmpeg to create a text file for FFmpeg.
- Minor tweaks:
  - subed-align: Use VTT as an intermediate format when re-aligning regions inside .ass and other formats not handled by aeneas
  - Expand more filenames.
  - Handle <c> in YouTube transcripts
  - ASS: Insert template only if empty
  - Update tests for Emacs 31 (thanks Jeff!)

** Version 1.5.1 - 2026-06-10 - Sacha Chua

- subed-menu: Correctly define the menu so that it appears.
- subed-wdiff-buffer-with-file: Handle Org files, use text properties to simplify analysis.
- Moved ./subed-autoloads.el to ./subed/subed-autoloads.el. If you load subed from a local copy, you may need to update your configuration to load the file from the new path.
