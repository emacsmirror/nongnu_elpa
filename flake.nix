      ...
      mkHermes =
        ...
        let
          ...
          elispFiles = [
            ...
            "lisp/hermes-chat-draft.el"
            "lisp/hermes-chat-prompts.el"
            "lisp/hermes-chat-images.el"
            "lisp/hermes-chat-todos.el"
            ...
            "lisp/hermes-files.el"
            "lisp/hermes-preview.el"
          ...
          testElFiles = [
            ...
            "hermes-chat-draft-tests.el"
            "hermes-chat-handoff-tests.el"
            "hermes-chat-images-tests.el"
            "hermes-chat-todos-tests.el"
            ...
            "hermes-projects-tests.el"
            "hermes-system-tests.el"
            "hermes-preview-tests.el"
            "hermes-files-tests.el"
            "hermes-test-helpers.el"
            "hermes-chat-format-tests.el"
            "hermes-chat-fences-tests.el"
            "hermes-chat-terminal-tests.el"
            "hermes-chat-wire-tests.el"
            "hermes-chat-history-tests.el"
            "hermes-chat-lifecycle-tests.el"
            "hermes-chat-queue-tests.el"
            "hermes-chat-slash-tests.el"
            "hermes-chat-buffer-tests.el"
            "hermes-chat-render-tests.el"
            "hermes-test-manifest-tests.el"
            "hermes-test-helpers-tests.el"
            "hermes-test-manifest.el"
