...
|            | mastodon-notifications-check                     | Check for the number of unread notifications.                                  |
...
|            | mastodon-notifications-revoke-post-quote         | Revoke the quote of a post from a quote notification.                          |
...
|            | mastodon-profile-feature-tag                     | Feature a tag on your profile.                                                 |
...
|            | mastodon-profile-load-featured-tag               | Prompt for a featured tag, and load posts containing it.                       |
...
|            | mastodon-profile-open-statuses-only-toots        | Open a profile buffer showing neither boosts nor replies.                      |
| C-c #      | mastodon-profile-open-statuses-tagged            | Prompt for a TAG and display a profile with statuses containing it.            |
|            | mastodon-profile-own-featured-tags               | Display your own featured tags.                                                |
...
|            | mastodon-profile-set-quote-policy                | Prompt for a quote policy and set it in the user's preferences.                |
...
|            | mastodon-tl--change-post-quote-policy            | Change the quote policy of the toot at point.                                  |
...
|            | mastodon-tl-continued-thread-load                | Load thread based on prop item-id.                                             |
...
| C-#        | mastodon-tl-list-followed-tags                   | List followed tags. View timeline of tag user choses.                          |
...
| C-M-'      | mastodon-tl-tag-all-timeline                     | Load a timeline of all tags in `mastodon-tl--tags-groups'.                     |
...
| C-c C-a    | mastodon-toot-attach-media                       | Prompt for an attachment file.                                                 |
...
| C-,        | mastodon-toot-jump-to-quoting                    | Prompt for a toot quoting the toot at point and load it.                       |
...
| "          | mastodon-toot-quote                              | Compose a toot quoting the toot at point.                                      |
...
| C-c C-u    | mastodon-toot-set-quote-policy                   | Set quote policy for the current toot.                                         |
...
|            | mastodon-views-add-to-collection                 | Add account being viewed to a collection.                                      |
...
|            | mastodon-views-collections-user-in               | Prompt for a collection you are in and view it.                                |
|            | mastodon-views-copy-scheduled-toot-text          | Copy the text of the scheduled toot at point.                                  |
|            | mastodon-views-create-collection                 | Create a new collection.                                                       |
| c          | mastodon-views-create-filter                     | Create a filter for a word.                                                    |
| C          | mastodon-views-create-list                       | Create a new list.                                                             |
|            | mastodon-views-delete-collection                 | Delete the collection currently being viewed.                                  |
...
|            | mastodon-views-instance-desc-lemmy               | Show instance description for a lemmy server.                                  |
|            | mastodon-views-instance-desc-misskey             | Show instance description for a misskey/firefish server.                       |
|            | mastodon-views-reload-collection                 | Reload current collection view.                                                |
...
|            | mastodon-views-remove-from-collection            | Remove item at point from collection.                                          |
| r          | mastodon-views-reschedule-toot                   | Reschedule the scheduled toot at point.                                        |
|            | mastodon-views-revoke-collection-inclusion       | Revoke your inclusion in a collection.                                         |
|            | mastodon-views-update-collection                 | Prompt for a collection and edit it.                                           |
|            | mastodon-views-update-current-collection         | Edit the collection being viewed if permitted.                                 |
...
| `          | mastodon-views-view-own-collection               | Prompt for a collection of yours and view it.                                  |
...
|            | mastodon-views-view-profile-collection           | Prompt for a user profile collection and view it.                              |
...
#+BEGIN_SRC emacs-lisp :results table :colnames '("Custom variable" "Description") :exports results
  (defun var-get-doc (symbol)
    (or (get (indirect-variable symbol)
             'variable-documentation)
        (get symbol 'variable-documentation)
        ""))

  (defun var-doc (symbol)
    (let ((str (var-get-doc symbol)))
...
| mastodon-display-featured-tags-on-profiles         | Whether to display featured tags on user profiles.                           |
...
| mastodon-inspect-profile-requests                  | Whether to profile requests info.                                            |
...
| mastodon-notifications-alert-style                 | The type of alert.el style to use for mastodon.el notification alerts.       |
| mastodon-notifications-alerts                      | Whether to enable alert.el unread-notification alerts.                       |
| mastodon-notifications-alerts-interval             | How often to check for new notifications, in seconds.                        |
...
| mastodon-tl-use-nerd-icons                         | Whether to use nerd icons for icons/symbols.                                 |
