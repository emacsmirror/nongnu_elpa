...
| mastodon-notifications-alerts                      | Whether to enable alert.el alerts.                                           |
| mastodon-notifications-check-for-updates           | Whether to regularly check for new notifications.                            |
| mastodon-notifications-grouped-names-count         | The number of notification authors to display.                               |
| mastodon-notifications-updates-interval            | How often to check for new notifications, in seconds.                        |
