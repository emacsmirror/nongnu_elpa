...
Feed. It requires Emacs 28.1 and is available for download from [[https://melpa.org/][MELPA]]. The
Elfeed UI was inspired by [[https://notmuchmail.org/][notmuch]]. The database format is stable and is never
expected to change.
