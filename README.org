...
:PROPERTIES:
:CUSTOM_ID: elfeed-web-interface
:END:
...
http://localhost:8080/elfeed/ (check your =httpd-port=) with a browser.
See the =elfeed-web.el= header for endpoint documentation if you'd like
to access the Elfeed database through the web API.
