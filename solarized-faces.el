...
;;;;; marginalia
     ...
     `(marginalia-function ((,class (:foreground ,blue))))
     `(marginalia-symbol ((,class (:foreground ,cyan))))
     `(marginalia-list ((,class (:foreground ,base0))))
     `(marginalia-mode ((,class (:foreground ,green))))
     `(marginalia-version ((,class (:foreground ,base01))))
     `(marginalia-archive ((,class (:foreground ,yellow))))
     `(marginalia-installed ((,class (:foreground ,green))))
