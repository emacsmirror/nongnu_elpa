...
SRCS = lisp/hermes-transport.el lisp/hermes-dashboard-transport.el lisp/hermes-chat.el lisp/hermes-sessions.el lisp/hermes-inventory.el lisp/hermes-rollback.el lisp/hermes-subagents.el lisp/hermes.el
