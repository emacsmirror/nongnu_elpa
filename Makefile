...
SRCS = lisp/hermes-promise.el lisp/hermes-transport.el lisp/hermes-transport-cli.el lisp/hermes-dashboard-transport.el lisp/hermes-chat-format.el lisp/hermes-chat-buffer.el lisp/hermes-chat-prompts.el lisp/hermes-chat-dashboard.el lisp/hermes-chat.el lisp/hermes-browser.el lisp/hermes-sessions.el lisp/hermes-inventory.el lisp/hermes-rollback.el lisp/hermes-subagents.el lisp/hermes-cron.el lisp/hermes-kanban.el lisp/hermes-mcp.el lisp/hermes-exec.el lisp/hermes-onboarding.el lisp/hermes-capabilities.el lisp/hermes.el
