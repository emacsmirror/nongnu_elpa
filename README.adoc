...
- table highlighting for the PSV (`|===`), CSV (`,===`), and DSV (`:===`) formats - PSV is the most common and flexible, so reach for it unless you're pasting comma- or colon-separated data
