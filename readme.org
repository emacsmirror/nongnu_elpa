...
- quick jump to any issue or repo in a listing with imenu.
...
[[file:screenshot-user.png][file:./screenshot-user.png]]

[[file:screenshot-search.png][file:./screenshot-search.png]]

[[file:screenshot-issues.png][file:./screenshot-issues.png]]
...
|         | fj-issue-view-edit-item-at-point | Edit issue or comment at point in issue view mode.                  |
...
|         | fj-repo-copy-clone-url           | Add the clone_url of repo at point to the kill ring.                |
