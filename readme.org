...
This repo contains some extremely basic functions for interacting with a Forgejo instance (such as https://codeberg.org) from within Emacs.
...
|---------+------------------------------+--------------------------------------------------------------------|
|         | fj-comment-edit              | Edit comment on ISSUE in REPO.                                     |
|         | fj-create-repo               | Create a new repo.                                                 |
...
|         | fj-list-issues-list          | List issues for current repo, or for REPO.                         |
|         | fj-view-issue                | View issue number NUMBER from REPO.                                |
