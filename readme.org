...
|         | fj-issues-ts-close-issue      | Close current issue from tabulated issues listing.                 |
|         | fj-issues-ts-comment-issue    | Comment on issue from tabulated issues listing.                    |
|         | fj-issues-ts-edit-issue       | Edit issue from tabulated issues listing.                          |
|         | fj-issues-ts-edit-issue-title | Edit title of issue from tabulated issues listing.                 |
|         | fj-issues-ts-view-issue       | View current issue from tabulated issues listing.                  |
