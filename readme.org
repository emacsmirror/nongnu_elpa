...
- list repo issues/PRs
- act on an issue/PR from issues/PR listing (edit, edit title, comment, close, reopen, delete)
- search in repo issues/PRs

- quick jump to any issue/PR or repo in a listing with imenu.


- view issue/PR discussion (reply or delete comment, or act on issue as above)
- viewing issue/PR, jump to mentioned user, issue or commit.
...
|         | fj-issue-view                    | View item NUMBER from REPO of OWNER.                                |
