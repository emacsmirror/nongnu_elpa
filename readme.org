...
|           | fj-list-own-items-state-cycle    | Cycle item state listing of open, closed, and all.                  |
|           | fj-list-own-items-type-cycle     | Cycle item type listing of issues, pulls, and all.                  |
