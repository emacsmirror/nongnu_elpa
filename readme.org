...
|         | fj-issue-create               | Create an issue in REPO owned by USER.                           |
...
|         | fj-issue-view-close           | Close issue being viewed.                                        |
...
|         | fj-user-repo-tl-star          | Star or UNSTAR current repo from tabulated user repos listing.   |
