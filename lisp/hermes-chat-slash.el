...
(declare-function hermes-chat--listify "hermes-chat" (value))
(declare-function hermes-chat--maplike-entries "hermes-chat" (value))
(declare-function hermes-chat--pair-command "hermes-chat" (pair))
(declare-function hermes-chat--pair-description "hermes-chat" (pair))
(declare-function hermes-chat--new-buffer "hermes-chat" (&optional profile title))
(declare-function hermes-chat--result-string "hermes-chat" (result key))
(declare-function hermes-chat--scalar-string "hermes-chat" (value))
